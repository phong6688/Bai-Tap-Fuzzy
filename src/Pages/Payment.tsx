            ...
            <li className="w-100">
              <div className="payment-detail">
                <label className="form-label" htmlFor="three">
                  <img className="img-fluid img" src="assets/images/icons/svg/paypal.svg" alt="mastercard" />
                  <span>
            ...
            <li className="w-100">
              <div className="payment-detail">
                <label className="form-label" htmlFor="four">
                  <img className="img-fluid img1" src="assets/images/icons/svg/apple-pay.svg" alt="apple-pay" />
                  <span>
            ...
            <li className="w-100">
              <div className="payment-detail">
                <label className="form-label" htmlFor="five">
                  <img className="img-fluid img" src="assets/images/icons/svg/google-pay.svg" alt="google-pay" />
                  <span>
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-body">
            ...
            <a href="#/landing" className="btn gray-btn mt-3">Continue Shopping</a>
          </div>
        </div>
      </div>
    </div>
