      ...
      <div className="custom-container">
        <div className="row g-3">
          <div className="col-12">
            <div className="notification-product-box">
              <a href="#" className="notification-product-img">
                <img className="img-fluid notification-icons" src="assets/images/svg/discount.svg" alt="discount" />
              </a>
          ...
          <div className="col-12">
            <div className="notification-product-box">
              <a href="#" className="notification-product-img notification-img">
                <img className="img-fluid notification-icons" src="assets/images/svg/wallet.svg" alt="wallet" />
              </a>
              <div className="notification-product-details notification-details">
                <div className="w-100">
          ...
          <div className="col-12">
            <div className="notification-product-box">
              <a href="#" className="notification-product-img notification-img">
                <img className="img-fluid notification-icons" src="assets/images/svg/location.svg" alt="location" />
              </a>
              <div className="notification-product-details notification-details">
                <div className="w-100">
          ...
          <div className="col-12">
            <div className="notification-product-box">
              <a href="#" className="notification-product-img notification-img">
                <img className="img-fluid notification-icons" src="assets/images/svg/card.svg" alt="card" />
              </a>
              <div className="notification-product-details notification-details">
                <div className="w-100">
          ...
          <div className="col-12">
            <div className="notification-product-box">
              <a href="#" className="notification-product-img notification-img">
                <img className="img-fluid notification-icons" src="assets/images/svg/profile-fill.svg" alt="profile" />
              </a>
              <div className="notification-product-details notification-details">
                <div className="w-100">
