        ...
        <div className="swiper-wrapper">
          <div className="swiper-slide">
            ...
            <div className="onboarding-design">
              ...
              <img className="img-fluid slider-img1" src="assets/images/onboarding/1.png" alt="slider-1" />
          ...
          <div className="swiper-slide">
            ...
            <div className="onboarding-design">
              ...
              <img className="img-fluid slider-img2" src="assets/images/onboarding/2.png" alt="slider-2" />
          ...
          <div className="swiper-slide">
            ...
            <div className="onboarding-design">
              ...
              <img className="img-fluid slider-img3" src="assets/images/onboarding/3.png" alt="slider-3" />
    ...
    <div className="offcanvas offcanvas-bottom addtohome-popup theme-offcanvas" tabIndex={-1} id="offcanvas">
      ...
      <div className="offcanvas-body small">
        <div className="app-info">
          <img src="assets/images/logo/48.png" className="img-fluid" alt="" />
